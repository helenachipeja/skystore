...
<body>
    ...
    <!-- Contact Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Contacte-nos</span></h2>
        <div class="row px-xl-5">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        <div class="control-group">
                            <input type="text" class="form-control" id="name" placeholder="Teu Nome"
                                required="required" data-validation-required-message="Entre com teu nome" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="email" class="form-control" id="email" placeholder="Teu Email"
                                required="required" data-validation-required-message="Entre com teu email" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" placeholder="Assunto"
                                required="required" data-validation-required-message="Digite o Assunto" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="bg-light p-30 mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+258 345 67890</p>
                </div>
            </div>
        </div>
    </div>
